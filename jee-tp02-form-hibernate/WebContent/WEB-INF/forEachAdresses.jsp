		...
		<c:forEach var="adresse" items="${adresses }">
			...
			<tr>
				...
				<c:forEach var="client" items="${clients}">
					<c:if test="${adresse.clientID == client.id}">
				...
				<td>
					<a href="updateAdresse?id=<c:out value='${adresse.id}' />">Edit</a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="deleteAdresse?id=<c:out value='${adresse.id}' />">Delete</a>
				</td>
			</tr>
		</c:forEach>
	</table>
